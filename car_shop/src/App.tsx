              ...
              >
                {selectedOwnedCategory && (
                  <motion.div>
                    ...
                    {ownedVehicles[
                      selectedOwnedCategory as keyof typeof ownedVehicles
                    ]?.map((item) => (
                      <motion.button
                        key={item.name}
                        className={`w-full hover:bg-midnight transition-colors`}
              ...
              >
                {selectedCategory && (
                  <motion.div>
                    ...
                    {vehicles[selectedCategory as keyof typeof vehicles]?.map(
                      (item) => (
                        <motion.button
          ...
          >
            <div className="flex">
              <div className="mr-[3vh] flex items-center space-x-[1vh] bg-semiblack p-[1vh] pl-[2vh] pr-[2vh] rounded-sm uppercase text-white text-[1.6vh]">
                ...
                <button
                  className="bg-white text-white w-[2.6vh] h-[2.6vh] rounded-full"
              ...
              <div className="space-x-[1.4vh] text-[2vh]  bg-semiblack p-[1vh] pl-[2vh] pr-[2vh] rounded-sm">
                <button
                  className="bg-green-500 p-[1vh] rounded-sm"
                  onClick={() => buySelectItem()}
                >
                  <BiSolidPurchaseTag />
                </button>
                <button
                  className="bg-red-500 p-[1vh] rounded-sm"
