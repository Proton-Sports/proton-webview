...
function App() {
  ...
  return (
    ...
    <div className='z-10 absolute top-[10vh] right-[6vh] -translate-x-1/2 -translate-y-1/2 font text-[1.6vh] text-black  uppercase bg-[rgb(255,255,255)] text-fix rounded-md border-[0.5vh] border-[rgba(167,167,167,0.6)]'>
        <p>esc</p>
    </div>
